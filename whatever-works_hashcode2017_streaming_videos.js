...
var timeElapsed = 0
setInterval(function(){timeElapsed += 1}, 1000)
...
function run (input) {
    ...
    print("solution object:", solutionForCacheServer)
	...
	if (isNode) {
        ...
        fs.writeFile(fileName + ".out", solution, function(err) {
            ...
            console.log("saved output to file "+fileName+".out")
        })
    }
...
//	if (!isNode)
	...
	args.push("time elapsed:")
	args.push(timeElapsed)
